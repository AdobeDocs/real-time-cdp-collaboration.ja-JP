...
* 概要 {#overview}
   ...
   * [Real-Time CDP Collaboration スターター](./overview/starter-overview.md)
* 設定 {#setup}
   * [「設定」セクションの概要](./setup/setup-overview.md)
   * [アカウントのオンボードと管理](./setup/onboard-account.md)
   * Sourceとオーディエンスの管理 {#source-audiences}
      * [オーディエンスソーシング用のAEPの設定](./setup/onboard-audiences.md)
      ...
      * [オーディエンスソーシング用の CSV ファイルをアップロード](./setup/upload-csv-audience-sourcing.md)
...
* 共同作業 {#collaborate}
   ...
   * Advertising platform connections {#ad-platform-connections}
      ...
      * [AMC 測定レポートの作成](./collaborate/advertising-platforms/amc-measure.md)
* 宛先 {#destinations}

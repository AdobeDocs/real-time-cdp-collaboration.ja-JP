...
[C4、C5、C9、S1、S2、PSPDおよびRHD データ使用ラベル ](https://experienceleague.adobe.com/en/docs/experience-platform/data-governance/labels/reference#contract){target="_blank"}の詳細をご覧ください。

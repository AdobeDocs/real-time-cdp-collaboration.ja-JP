...
### 結合キーを選択 {#select-join-key}

>[!CONTEXTUALHELP]
>id="rtcdp_collaboration_import_crosswalk_join_key"
>title="結合キー"
>abstract="結合キーは、異なるデータセット間でレコードを照合およびリンクするために使用される一意の識別子です。 これにより、様々なソースからのデータを、同じ個人またはエンティティに正確に関連付けることができます。 選択した横断歩道の列ヘッダーは、結合キーとして使用できます。"

結合キーは、異なるデータセット間でレコードを照合およびリンクするために使用される一意の識別子です。 これにより、様々なソースからのデータを、同じ個人またはエンティティに正確に関連付けることができます。 適切な結合キーを選択すると、データを効果的に結合および調整でき、キャンペーンの精度と完全性が向上します。

選択した横断歩道の列ヘッダーは、結合キーとして使用できます。

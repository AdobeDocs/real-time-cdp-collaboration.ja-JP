...
* **[!DNL Amazon S3]オーディエンスソーシング仕様（v1.1）** に準拠するオーディエンスファイルを含む **[アクティブな](../../assets/quick-start/RTCDP_Collaboration_Audience_Sourcing_Spec_v1.2.pdf)** バケットにアクセスできます。
...
データ接続として **[!UICONTROL 0}Amazon S3} を選択し、続いて]** 次へ **[!UICONTROL を選択します。]**
...
オーディエンスファイルをどのように構造化する必要があるかを説明するダイアログが表示されます。 **[[!UICONTROL オーディエンスソーシングの仕様]](../../assets/quick-start/RTCDP_Collaboration_Audience_Sourcing_Spec_v1.2.pdf)** へのリンクを使用して、[!DNL Amazon S3] for Collaborationのオーディエンスデータを書式設定および構造化して正しく読み取る方法を確認します。

...
[!DNL Snowflake]、[!DNL Amazon S3]、[!DNL Google Cloud Storage]などのクラウドソースを設定するには、[Audience Specification PDF](../assets/quick-start/RTCDP_Collaboration_Audience_Sourcing_Spec_v1.3.pdf)を使用してオーディエンスデータを準備します

...
[!DNL Snowflake] や [!DNL Amazon S3] などのクラウドソースを設定するには、[&#x200B; オーディエンス仕様PDF](../assets/quick-start/RTCDP_Collaboration_Audience_Sourcing_Spec_v1.1.pdf) を使用してオーディエンスデータを準備します

...
>title="広告主名（AmazonMarketing Cloud）"
>abstract="Amazon Marketing Cloud（AMC）接続の場合、このフィールドは、Amazon Ads ログインがアクセスできる AMC インスタンスを表します。 広告主名は反映されません。 必要なインスタンスがリストに表示されない場合は、Amazon Marketing Cloud管理者に連絡してアクセス権をリクエストしてください。"

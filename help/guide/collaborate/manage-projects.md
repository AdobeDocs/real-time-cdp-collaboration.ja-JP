...
プロジェクトを作成するには、まず[共同作業者との接続を確立する](/help/guide/connect/establishing-connections.md)必要があります。 接続が確立されたら、その共同作業者と一緒にプロジェクトを作成できます。
...
>[!NOTE]
>
> 接続設定で1つの広告主名を設定した場合、デフォルトで表示されます。 広告主名が設定されていない場合、広告主の&#x200B;**[!UICONTROL 名]**&#x200B;は&#x200B;**[!UICONTROL 広告主名]**&#x200B;として事前に選択されています。

...
| **[!UICONTROL オーディエンスインデックス]** | 基になるオーディエンスサイズと重複に基づいて、あるオーディエンスと別のオーディエンスの関係の強さを示すスコア。 スコアの意味について詳しくは、[ オーディエンスインデックススコア ](#audience-index-score) の節を参照してください。 共同作業者のベースライン（すべてのオーディエンス）と比較する場合、オーディエンスインデックススコアは使用できません。 |
...
| **[!UICONTROL オーディエンスインデックス]** | 基になるオーディエンスサイズと重複に基づいて、あるオーディエンスと別のオーディエンスの関係の強さを示すスコア。 スコアの意味について詳しくは、[ オーディエンスインデックススコア ](#audience-index-score) の節を参照してください。 |
